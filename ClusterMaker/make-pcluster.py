...
parser.add_argument('--cluster_owner_department', choices=['hpc', 'compchem', 'compbio', 'scicomp', 'cloudteam', 'datasci', 'infrastructure', 'operations', 'design', 'robotics', 'proteomics', 'development', 'qa', 'research', 'commercial', 'manufacturing', 'clinical', 'finance', 'analytics'], help='department of the cluster owner (default = research)', required=False, default='research')
