...
# Purpose: Print a header inviting the user to abort a cluster action
...
ec2_instances_full_list = ec2_instances_general_purpose + ec2_instances_compute_optimized + ec2_instances_memory_optimized + ec2_instances_storage_optimized + ec2_instances_accelerated_computing
